                                        ...
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="{{ url($getCartProduct->slug) }}">
                                                    <img src="{{ $getProducrImage->getImageLog() }}" alt="Product image">
                                                </a>
                                            </figure>
                                            ...
                                            <h3 class="product-title">
                                                ...
                                                @if(!empty($color_id))
                                                 ...
                                                 @php
                                                  $getColor = App\Models\Backend\Color::getSingle($color_id);
                                                 @endphp
                                                ...
                                                @if(!empty($size_id))
                                                 ...
                                                 @php
                                                  $getsize = App\Models\Backend\ProductSize::getSingle($size_id);
                                                 @endphp
