              ...
              <form action="" method="post">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required value="{{ old('name', $getRecord->name) }}" name="name" placeholder="Enter Discount Code Name">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required value="{{ old('percent_amount', $getRecord->percent_amount) }}" name="percent_amount" placeholder="Enter Percent / Amount">
                  </div>
