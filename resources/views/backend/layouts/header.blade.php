 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      @php
      $getUnreadNotification = App\Models\Backend\Notification::getUnreadNotification();
      @endphp
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header"> <i class="fas fa-envelope mr-2"></i>{{ $getUnreadNotification->count() }} Notifications</span>
