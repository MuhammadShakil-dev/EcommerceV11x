...
<main class="main">
            ...
            <div class="container">
                <div class="page-header page-header-big text-center" style="background-image: url('{{$getPage->getPageImage()}}')">
                                ...
                                <div class="col-sm-7">
                                    <div class="contact-info">
                                        ...
                                        <ul class="contact-list">
                                            ...
                                            @endif
                                            @if(!empty($getSystemSetting->mobile))
                                            <li>
                                                <i class="icon-phone"></i>
                                                <!-- <a href="tel:#">+92 423 567</a> -->
                                                <a href="tel:{{ $getSystemSetting->mobile }}">{{ $getSystemSetting->mobile }}</a>
                                            </li>
                                            @endif
                                            @if(!empty($getSystemSetting->office_email))
                                            <li>
                                                <i class="icon-envelope"></i>
                                                <!-- <a href="mailto:#">info@Molla.com</a> -->
                                                <a href="mailto:{{ $getSystemSetting->office_email }}">{{ $getSystemSetting->office_email }}</a>
                                            </li>
                                            @endif
                                    ...
                                    <div class="contact-info">
                                        ...
                                        <ul class="contact-list">
                                            ...
                                            <li>
                                                ...
                                                <span class="text-dark">{{ $getSystemSetting->working_hour }}</span>
                                            </li>
                                            @endif
                            ...
                            <form action="" method="post" class="contact-form mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="number" name="verification" class="form-control" id="verification" placeholder="verification Sum">
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
